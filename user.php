...
<?php  include("header.php"); ?>
        ...
        <div id="container">
            <div id="userdetail"  style="margin-bottom:50px;padding-bottom:10px;width: 620px;background:white;border:1px solid #72541d54;padding:20px;margin:10px;margin-left: 35%;box-shadow: inset 0px 0px 100px 100px white;;">
